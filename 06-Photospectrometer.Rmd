...
6. Performing Baseline Correction Measurements
    a. Open the hood on the spectrophotometer and insert the Baseline Reference on the designated areas
        ...
        ![Figure 1: Setup baseline reference for %T and Abs in the integrating sphere.](images/UH4150-Fig1.png)
      ...
      ![Figure 2: Setup baseline reference for %R in the integrating sphere.](images/UH4150-Fig2.png) 
...
![Figure 3: The measurement set up for both %T (Transmittance) and Abs (Absorbance).](images/UH4150-Fig3.png)
...
![Figure 4: The measurement set up for %R (Reflectance).](images/UH4150-Fig4.png)
