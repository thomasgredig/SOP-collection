...
![ARC2 Controller](images/cypherAFM_20221108_01.jpeg)
...
2 Open software "AR 18.10.29" on desktop.
...
![Mode Master Selector Menu](images/cypherAFM_20221108_04.png)
...
![AC mode operating screen.](images/cypherAFM_20221108_05.jpg)
...
![Tip lowering knob on Cypher AFM. Turn Clockwise to raise the tip and turn counter-clockwise to lower the tip.](images/cypherAFM_20221108_06.png){.CypherImagesCenter}
...
![Engage Panel](images/cypherAFM_20221108_07.jpg){.CypherImagesCenter}
...
![Sum and Deflection Panel](images/cypherAFM_20221108_08.jpg){.CypherImagesCenter}
...
-   Another good way to deterimine if you are near the surface is to see if the outter circle of the optical microscope is in focus, if it has sharp edges, then you are close to the surface, if it is not sharp then you are not near the surface.

### Tuning the Cantilever

1 Locate the the master panel, shown in the image below.

![Master Panel](images/cypherAFM_20221108_09.jpg){.CypherImagesCenter}

2 Click the "thermal" button in the blue side bar. Click "get real" and then click on the probe tip that you are using.
...
![Thermal Graph](images/cypherAFM_20221108_10.jpg)
...
3 Select the "Tune" button in the master panel, the following window should appear.

![Tune Window](images/cypherAFM_20221108_11.jpg)

4 In the Cantilever Tune window, click the "Adv" button in the blue side bar and change Piezo to BlueDrive (if wanting to use blue drive).

5 In the Cantilever Tune window, click on "Params" in the blue side bar and under "Auto Tune" change the "Target Percent" to -5.

6 Click "Auto Tune" in the Cantilever Tune window.

7 Record the values on cantilever tune graph (drive frequency [KHz], sweep width [KHz], drive amplitude [mW], tune q).

8 Determine your sample rate using eqn.
...
![Naming Restrictions](images/cypherAFM_20221108_13.jpg){.CypherImagesCenter}
...
![filter panel](images/cypherAFM_20221108_12.jpg){.CypherImagesCenter}

5 Compare the calculated sample to the sample rate displayed in the filter panel.

### Beginning the Scans

1 In the "Engage Panel" Click "Move to pre-engage".

2 Click "Begin tip approach".
...
3 Once the tip has finished its approach, click "engage" within the Sum and Deflection Panel.
...
4 Select "Frame Up" within the master panel.
...
-   Take screen shots or record the anomalous behavior and imform Dr. Gredig.
...
![igor image](images/cypherAFM_20221108_14.png)
